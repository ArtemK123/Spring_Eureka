...
public class ConfigsController {
    private final String FIRST_PROPERTY_NAME = "custom.test.gatewayProperty1";
    private final String SECOND_PROPERTY_NAME = "custom.test.gatewayProperty2";
    private final String THIRD_PROPERTY_NAME = "custom.test.gatewayProperty3";
